...
#define STRING_CONFIG_H_AUTHOR "Evan Sampson" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Green Dragon"
...
#define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current
  ...
  //
  #define DEFAULT_chamberKp 27.12
  #define DEFAULT_chamberKi 2.56
  #define DEFAULT_chamberKd 71.74
...
#define DEFAULT_EJERK    10.1  // May be used by Linear Advance
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -13, -1.55 }
